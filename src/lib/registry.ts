...
export const transforms: TransformConfig[] = [
  // --- Utilities (usage priority: Icon Search top, then high-traffic tools) ---
  {
    id: "icon-search",
    name: "Icon Search",
    category: "Utilities",
  ...
  },
  {
    ...
    inputLang: "markdown",
    outputLang: "html",
    placeholder: "Mermaid editor with live preview and Flow Board handoff.",
  },
  {
    id: "graph-lab",
    name: "Chart Studio",
    category: "Utilities",
    inputLabel: "Chart JSON",
    outputLabel: "Chart Preview",
    inputLang: "json",
    outputLang: "html",
    placeholder: "Render chart-ready JSON using modern Recharts chart types.",
  },
  {
    id: "gltf-viewer",
